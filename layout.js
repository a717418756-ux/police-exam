...
const TABS = [
  { id:'t-decision', icon:'🎯', name:'決策',
    cards:['gate-card','bingfa-card','resonance-card','health-card','formula-card','prob-card','playbook-card'] },
  ...
  { id:'t-chip', icon:'💰', name:'籌碼',
    cards:['mainforce-card','margin-card','chip-card','fundamental-card','rs-card','beta-card'] },
